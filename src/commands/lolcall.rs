...
const LOLCALL: &'static [&'static str] = &[
    ...
    "Oisipa hän lyönyt gravesia, vielä ei ole liian myöhäistä!!!",
    ...
    "Keisarin muistolle: NYT PELATAAN",
    "S-senpai.. lol time..",
    ...
    "MÄ MUISTAN SEN, KUIN EILISEN, KEISARIN PENTA KILLIN",
    ...
    "CALL TO ARMS",
    "CALL TO FARMS",
    ":D :D :D :D :D :D GO GO GO GO GO GO :D :D :D :D :D",
    "Ylemmän tahon käskystä, NYT PELATAAN",
    "Voisimmeko nyt vain olla hiljaa ja pelata lollia?",
    "Voisimmeko nyt vain pelata lollia?",
    "Voisimmeko ihan vähän pelata lollia?",
];
